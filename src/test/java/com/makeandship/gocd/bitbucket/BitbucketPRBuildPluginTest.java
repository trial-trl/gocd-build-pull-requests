package com.makeandship.gocd.bitbucket;
...
public class BitbucketPRBuildPluginTest {
    ...
    public void shouldHandleValidURLCorrectly_ValidationRequest() throws IOException {
        verifyValidationSuccess("https://yassire@bitbucket.org/makeandship/ms-gocd-pr-test.git");
    ...
    public void shouldGetLatestRevision() {
        ...
        when(request.requestBody()).thenReturn("{scm-configuration: {url: {value: \"https://yassire@bitbucket.org/makeandship/ms-gocd-pr-test.git\"}}, flyweight-folder: \"" + TEST_DIR + "\"}");
    ...
    public void shouldGetLatestRevisionSince() {
        ...
        GoPluginApiRequest request = mock(GoPluginApiRequest.class);
        when(request.requestBody()).thenReturn("{scm-configuration: {url: {value: \"https://yassire@bitbucket.org/makeandship/ms-gocd-pr-test.git\"}}, previous-revision: {revision: \"a683e0a27e66e710126f7697337efca052396a32\", data: {ACTIVE_PULL_REQUESTS: \"{\\\"1\\\": \\\"12c6ef2ae9843842e4800f2c4763388db81d6ec7\\\"}\"}}, flyweight-folder: \"" + TEST_DIR + "\"}");
    ...
    public void shouldReproduceGetLatestAndGetLatestSince() {
        GitHubPRBuildPlugin plugin = new GitHubPRBuildPlugin();
        Map url = new HashMap();
        url.put("value", "https://yassire@bitbucket.org/makeandship/ms-gocd-pr-test.git");
    ...
    private GoPluginApiRequest mockRequest() {
        ...
        when(request.requestBody()).thenReturn("{\n" +
                "    \"scm-configuration\": {\n" +
                "        \"url\": {\n" +
                "            \"value\": \"https://yassire@bitbucket.org/makeandship/ms-gocd-pr-test.git\"\n" +
                "        },\n" +
                "        \"branchwhitelist\": {\n" +
                "            \"value\": \"test*, feat*\"\n" +
                "        },\n" +
